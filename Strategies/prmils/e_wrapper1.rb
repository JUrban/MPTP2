...
params1 = " -s -R --memory-limit=Auto --print-statistics --definitional-cnf=24 --tstp-format #{splaggr_s} #{splcl_s}  #{simparamod_s} #{forwardcntxtsr_s} --destructive-er-aggressive --destructive-er --prefer-initial-clauses -t#{tord} #{prord} -F1 --delete-bad-limit=150000000 -W#{sel} -H'(" + heur + ")' --cpu-limit=#{cutoff_time} #{infilename}"
